package com.alertingweb.client;
...
import com.alertingweb.client.auth.Authentication;
import com.alertingweb.client.auth.HttpBasicAuth;
import com.alertingweb.client.auth.ApiKeyAuth;
import com.alertingweb.client.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("headerToken", new ApiKeyAuth("header", "X-Auth-Token"));
